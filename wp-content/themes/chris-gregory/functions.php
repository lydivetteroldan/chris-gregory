<?php
/**
 * Chris Gregory functions and definitions
 *
...
if ( ! function_exists( 'chris_gregory_setup' ) ) :
/**
 ...
 */
function chris_gregory_setup() {
	/*
	 * Make theme available for translation.
	 * Translations can be filed in the /languages/ directory.
	 * If you're building a theme based on Chris Gregory, use a find and replace
	 * to change 'chris-gregory' to the name of your theme in all the template files.
	 */
	load_theme_textdomain( 'chris-gregory', get_template_directory() . '/languages' );
	...
	register_nav_menus( array(
		'menu-1' => esc_html__( 'Primary', 'chris-gregory' ),
	...
	add_theme_support( 'custom-background', apply_filters( 'chris_gregory_custom_background_args', array(
 ...
 */
function chris_gregory_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'chris_gregory_content_width', 640 );
}
add_action( 'after_setup_theme', 'chris_gregory_content_width', 0 );
 ...
 */
function chris_gregory_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'chris-gregory' ),
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'chris-gregory' ),
...
add_action( 'widgets_init', 'chris_gregory_widgets_init' );
